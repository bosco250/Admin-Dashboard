    ...
    <div>
        ...
        <div className='container-fluid w-100'>
          <div className='row d-flex align-items-center w-100 '>
            ...
            <div className='col-sm-7 d-flex align-items-center justify-content-end'>
              ...
              <Button className='rounded-circle '  onClick={handleClick}><IoCartOutline /></Button>
               <Menu
        anchorEl={anchorEl}
        id="account-menu"
        open={open}
      ...
      >
        ...
        <div className='notification d-flex '>
          ...
          </div><div className='notification d-flex '>
          <div className='userImg d-flex align-items-center justify-content-center'>
          <span className='rounded-circle'>
              <Avatar src=''/>
            </span>
          ...
          <div className='info'>
            ...
            <span className='text-sky'>few seconds ago</span>
              ...
              <Button className='rounded-circle ' onClick={handleOpenNotificationDrop}><FaRegBell/></Button>
      ...
      >
        ...
        <Button variant='contained' sx={{width:'98%',paddingLeft:1,paddingRight:1,position: 'absolute', bottom:0 }}> View All Notifications</Button>
                </Menu>
              <div className='myAccDrop'>
              <Button className='myAcc d-flex align-items-center' onClick={handleOpenMyAccDrop}>
                <div className='userImg'>
                  <span className='rounded-circle'>
                    <Avatar src={UserImage} sx={{ border:'solid 1.5px #0858f7'}} />
                  </span>
                </div>
      ...
      >
        ...
        <MenuItem onClick={handleCloseMyAccDrop} sx={{color:'red'  }}>
          <ListItemIcon>
